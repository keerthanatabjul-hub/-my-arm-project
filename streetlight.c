   ...
   /*  if(is_night_time(hour) == 0)
    {
        ...
        */
        if(adc_value > LOW_DARK_THRESHOLD )
        {
            brightness = BRIGHTNESS_HIGH;
        }
        else if(adc_value > MEDIUM_DARK_THRESHOLD)
        {
            brightness = BRIGHTNESS_MEDIUM;
        }
				else if(adc_value > HIGH_DARK_THRESHOLD)
        {
        ...
        */
          if(adc_value < HIGH_DARK_THRESHOLD)
    {
       brightness = BRIGHTNESS_HIGH;
		}
    else if(adc_value < MEDIUM_DARK_THRESHOLD)
    ...
    else if(adc_value < LOW_DARK_THRESHOLD)
    {
         brightness = BRIGHTNESS_LOW;
    }
    else
